...
import { FormContainer, FormQuestion, FormQuestionList, FormSubmit, FormLabel, FormInput, FormHeader, Form } from './QuestionsElements.js';
	...
	return (
		<FormContainer onSubmit={handleSubmit}>
			...
			{description}
                         ...
                         <FormInput type='radio' name='question_one' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_one'>7</FormLabel>
                         <FormInput type='radio' name='question_one' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_one'>8</FormLabel>
                         <FormInput type='radio' name='question_one' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_one'>9</FormLabel>
                         <FormInput type='radio' name='question_one' value={10} onChange={handleChange}></FormInput>
				...
				<FormQuestion>{q2}</FormQuestion>
                         ...
                         <FormInput type='radio' name='question_two' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_two'>7</FormLabel>
                         <FormInput type='radio' name='question_two' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_two'>8</FormLabel>
                         <FormInput type='radio' name='question_two' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_two'>9</FormLabel>
                         <FormInput type='radio' name='question_two' value={10} onChange={handleChange}></FormInput>
				...
				<FormQuestion>{q3}</FormQuestion>
                         ...
                         <FormInput type='radio' name='question_three' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_three'>7</FormLabel>
                         <FormInput type='radio' name='question_three' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_three'>8</FormLabel>
                         <FormInput type='radio' name='question_three' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_three'>9</FormLabel>
                         <FormInput type='radio' name='question_three' value={10} onChange={handleChange}></FormInput>
				...
				<FormQuestion>{q4}</FormQuestion>
                         ...
                         <FormInput type='radio' name='question_four' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_four'>7</FormLabel>
                         <FormInput type='radio' name='question_four' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_four'>8</FormLabel>
                         <FormInput type='radio' name='question_four' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_four'>9</FormLabel>
                         <FormInput type='radio' name='question_four' value={10} onChange={handleChange}></FormInput>
				...
				<FormQuestion>{q5}</FormQuestion>
                         ...
                         <FormInput type='radio' name='question_five' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_five'>7</FormLabel>
                         <FormInput type='radio' name='question_five' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_five'>8</FormLabel>
                         <FormInput type='radio' name='question_five' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_five'>9</FormLabel>
                         <FormInput type='radio' name='question_five' value={10} onChange={handleChange}></FormInput>
				...
				<FormQuestion>{q6}</FormQuestion>
                         ...
                         <FormInput type='radio' name='question_six' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_six'>7</FormLabel>
                         <FormInput type='radio' name='question_six' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_six'>8</FormLabel>
                         <FormInput type='radio' name='question_six' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_six'>9</FormLabel>
                         <FormInput type='radio' name='question_six' value={10} onChange={handleChange}></FormInput>
				...
				<FormQuestion>{q7}</FormQuestion>
                         ...
                         <FormInput type='radio' name='question_seven' value={7} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_seven'>7</FormLabel>
                         <FormInput type='radio' name='question_seven' value={8} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_seven'>8</FormLabel>
                         <FormInput type='radio' name='question_seven' value={9} onChange={handleChange}></FormInput>
                         <FormLabel htmlFor='question_seven'>9</FormLabel>
                         <FormInput type='radio' name='question_seven' value={10} onChange={handleChange}></FormInput>
